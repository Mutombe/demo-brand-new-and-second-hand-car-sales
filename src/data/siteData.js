...
const siteData = {
  business: {
    name: "Brand new and Second hand Car Sales",
    legalName: "Brand new and Second hand Car Sales",
    tagline: "New & Pre-Owned Vehicles at Best Prices",
    description: "Your one-stop destination for brand new and second-hand vehicles in Harare. Quality cars, transparent pricing, and financing options that make car ownership accessible to every Zimbabwean.",
    phone: "+263 71 813 6826",
    phoneRaw: "+263718136826",
    whatsappNumber: "263718136826",
    email: "sales@carsalesharare.co.zw",
    address: "2991, Harare, Zimbabwe",
    country: "Zimbabwe",
    city: "Harare",
    rating: 5,
    ratingRounded: 5,
    ...
    cookieConsentKey: "brand-new-and-second-hand-car-sales-cookie-consent",
    socialLinks: {
      facebook: "#",
      instagram: "#",
      linkedin: "#",
  ...
  hero: {
    badge: "Harare's Destination for New & Pre-Owned Cars",
    titleParts: [
      { text: "QUALITY CARS" },
      { text: "HONEST", highlight: true },
      { text: "DEALS." },
    ],
    subtitle: "Your one-stop destination for brand new and second-hand vehicles in Harare. Quality cars, transparent pricing, and financing options that make car ownership accessible to every Zimbabwean.",
    ctaPrimary: "Browse Cars",
    ctaSecondary: "Get Financing",
    trustBadge: "2000+ Clients Served",
    backgroundImages: [
  ...
  stats: [
    { number: "2000+", label: "Vehicles Sold" },
  ...
  homeTestimonials: [
    { text: "Bought my first car from Brand new and Second hand Car Sales and the experience was incredible. No pressure, honest advice, and they helped me secure financing that fit my budget perfectly.", name: "Wellington Moyo", role: "First-Time Buyer", rating: 5, avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&q=80" },
    { text: "We purchased 8 vehicles for our company fleet and Brand new and Second hand Car Sales handled everything -- sourcing, inspection, registration, and delivery. Professional from start to finish.", name: "Chenai Dziva", role: "Fleet Procurement Manager", rating: 5, avatar: "https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?w=100&q=80" },
    { text: "This is my third vehicle from Brand new and Second hand Car Sales. I keep coming back because they are honest, their cars are well-inspected, and the after-sales support is genuine.", name: "Tapiwa Gondo", role: "Returning Customer", rating: 5, avatar: "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=100&q=80" },
  ...
  about: {
    ...
    story: [
      "Since 2016, we have been matching Harare drivers with their ideal vehicles. Whether you are looking for a brand-new import or a reliable second-hand daily driver, our forecourt has something for every budget.",
      "With over 2,000 vehicles sold and partnerships with Zimbabwe's leading finance houses, we have made car ownership accessible and stress-free for thousands of families.",
    ],
    values: [
    ...
    team: [
      { name: "Team Leader", role: "Director", bio: "Leading Brand new and Second hand Car Sales with expertise and vision.", image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&q=80" },
  ...
  reviews: {
    ...
    items: [
      { text: "Bought my first car from Brand new and Second hand Car Sales and the experience was incredible. No pressure, honest advice, and they helped me secure financing that fit my budget perfectly.", name: "Wellington Moyo", role: "First-Time Buyer", rating: 5 },
      { text: "We purchased 8 vehicles for our company fleet and Brand new and Second hand Car Sales handled everything -- sourcing, inspection, registration, and delivery. Professional from start to finish.", name: "Chenai Dziva", role: "Fleet Procurement Manager", rating: 5 },
      { text: "This is my third vehicle from Brand new and Second hand Car Sales. I keep coming back because they are honest, their cars are well-inspected, and the after-sales support is genuine.", name: "Tapiwa Gondo", role: "Returning Customer", rating: 5 },
      ...
      { text: "The inspection report Brand new and Second hand Car Sales provided was more detailed than what I got from a dealership. Impressive transparency.", name: "Simba Karonga", role: "Careful Buyer", rating: 5 },
      { text: "Finance approval came through in 48 hours. Brand new and Second hand Car Sales made the entire process painless.", name: "Douglas Mhizha", role: "Finance Client", rating: 5 },
      { text: "Drove 3 hours from Mutare to buy from Brand new and Second hand Car Sales because their reputation is that good. Was not disappointed.", name: "Linda Masuku", role: "Out-of-Town Buyer", rating: 5 },
      { text: "Great selection and no high-pressure sales tactics. Brand new and Second hand Car Sales let me take my time and make the right decision.", name: "Patrick Makoni", role: "Browser Turned Buyer", rating: 5 },
      { text: "The after-sales follow-up from Brand new and Second hand Car Sales was a pleasant surprise. They genuinely care about customer satisfaction.", name: "Angela Mhembere", role: "Satisfied Customer", rating: 5 },
      { text: "Registration, insurance, and financing all handled by Brand new and Second hand Car Sales. I just signed and drove away. Incredible service.", name: "Brian Mutema", role: "Complete Package Client", rating: 5 },
    ],
  },
  ...
  contact: {
    ...
    branches: [
      { name: "Main Office", address: "2991, Harare, Zimbabwe", phone: "+263 71 813 6826", email: "sales@carsalesharare.co.zw" },
    ],
  },

  homeCta: {
    title: "YOUR PERFECT CAR, AWAITS",
    subtitle: "Your one-stop destination for brand new and second-hand vehicles in Harare. Quality cars, transparent pricing, and financing options that make car ownership accessible to every Zimbabwean.",
    ctaPrimary: "Browse Cars",
    ctaSecondary: "Chat on WhatsApp",
    whatsappText: "Hello! I'm looking for a vehicle. What do you have available?",
    backgroundImage: "https://images.unsplash.com/photo-1489824904134-891ab64532f1?w=1920&q=85",
  },

  footer: {
    description: "Your one-stop destination for brand new and second-hand vehicles in Harare. Quality cars, transparent pricing, and finan...",
    copyright: "Brand new and Second hand Car Sales",
  },
};
